/**
 * Copyright 2024 Valentin Chevalier <contact@chevalierv.be> (@chevalierv)
 *
...
#define ______________HOME_ROW_CAGS_L______________ KC_LCTL, KC_LOPT, KC_LCMD, KC_LSFT, XXXXXXX
#define ______________HOME_ROW_CAGS_R______________ XXXXXXX, KC_RSFT, KC_RCMD, KC_ROPT, KC_RCTL
...
#define LAYOUT_LAYER_FUNCTION                                                                 \
    ...
    ______________HOME_ROW_CAGS_L______________, KC_MCTL,   KC_F4,   KC_F5,   KC_F6,  KC_F11, \
    _______________DEAD_HALF_ROW_______________, KC_LPAD,   KC_F1,   KC_F2,   KC_F3,  KC_F10, \
...
#define LAYOUT_LAYER_MEDIA                                                                    \
    ...
    _______________DEAD_HALF_ROW_______________, QK_BOOT,  EE_CLR, XXXXXXX, XXXXXXX, XXXXXXX, \
...
#define LAYOUT_LAYER_NUMERAL                                                                  \
    ...
    KC_NUBS,    KC_1,    KC_2,    KC_3, KC_NUHS, _______________DEAD_HALF_ROW_______________, \
...
#define LAYOUT_LAYER_SYMBOLS                                                                  \
    ...
    LSFT(KC_NUBS), KC_EXLM,   KC_AT, KC_HASH, LSFT(KC_NUHS), _______________DEAD_HALF_ROW_______________, \
                      KC_LPRN, KC_RPRN, KC_UNDS, _______, XXXXXXX

/**
 * \brief Add Home Row mod to a layout.
 *
 * Expects a 10-key per row layout.  Adds support for CAGS (Control, Option, Command, Shift)
 * home row.  The layout passed in parameter must contain at least 20 keycodes.
 *
 * This is meant to be used with `LAYER_BASE` defined above, eg.:
 *
 *     _HOME_ROW_MOD_CAGS(LAYER_BASE)
 */
#define _HOME_ROW_MOD_CAGS(                                            \
    ...
    ...)                                                               \
             L00,         L01,         L02,         L03,         L04,  \
             R05,         R06,         R07,         R08,         R09,  \
      LCTL_T(L10), LOPT_T(L11), LCMD_T(L12), LSFT_T(L13),        L14,  \
             R15,  RSFT_T(R16), RCMD_T(R17), ROPT_T(R18), RCTL_T(R19), \
      __VA_ARGS__
